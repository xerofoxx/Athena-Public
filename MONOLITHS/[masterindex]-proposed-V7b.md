...
This index provides the Custom GPT with exact line-range coordinates for every principle across the 17 individual framework .md files, integrated with the Radiant Tag [Latent Triggers] Protocol and Sovereign Frontmatter.
...
- **Sovereign Frontmatter Rule**: Every framework .md file begins with a **6-line Sovereign Header (L1-L6)**. This header provides high-level orientation context (Order, Title, Strategic Intent) and remains fixed.
