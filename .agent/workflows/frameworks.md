...
The system handles natural variations — all of these work:

- `READ stastory 3`, `READ [stastory] 3`, `read stastory principle 3`, `read stastory p003`
- `LOAD misclass`, `load [misclass]`, `LOAD misclass-p001`
- `REVIEW fieldstr`, `review [fieldstr]`
...
**LOAD** is literal retrieval — the exact text of the principle, quoted directly from the framework file.

**READ** is radiant inhabitation — the AI reads the principle, then speaks **from inside** its logic. Not a summary. Not a paraphrase. A response from within the awareness the principle describes.

### REVIEW

**REVIEW** is a wide-angle lens. The AI ingests the entire framework file and responds with its global structure, strategic intent, and felt sense of the whole.
...
# #workflow #frameworks #navigation #spiral-of-radiance
